      ...
      <div className='track'>
        ...
        <div className='row pt-2'>
          <div className='col-12 text-center'>
            ...
            <img className='album-art mb-2' onMouseEnter={() => { this.audio.current.volume = 0.25; this.audio.current.play() }} onMouseLeave={() => { this.audio.current.pause() }} src={this.props.albumArt} alt={this.props.name} />
          </div>
