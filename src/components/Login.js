      ...
      return (
        <div>
          <div className='container text-center text-white'>
            ...
            <a className='spotify-login' href={`https://accounts.spotify.com/authorize?client_id=5d549dda46474e9e8422bc9803497cb6&redirect_uri=http%3A%2F%2Fmusifeel.netlify.com%2Fsuggest&scope=user-top-read%20playlist-modify-public&response_type=token&state=123`}><i className='fab fa-spotify fa-lg pr-1'/> Login with Spotify</a>
          </div>
        </div>
      )
    }
